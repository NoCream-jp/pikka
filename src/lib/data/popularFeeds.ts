...
export const popularFeeds: PopularFeed[] = [
  ...
  {
    name: 'Publickey',
    keywords: ['publickey', 'パブリックキー'],
    url: 'https://www.publickey1.jp/atom.xml'
  },
  {
    name: 'ITmedia NEWS',
    keywords: ['itmedia', 'ニュース'],
  ...
  },
  {
    ...
    keywords: ['wantedly', 'ウォンテッドリー', 'ウォント'],
    url: 'https://www.wantedly.com/companies/wantedly/post_articles/rss.xml'
  },
  {
    name: 'MIXI DEVELOPERS',
    keywords: ['mixi', 'ミクシィ'],
    url: 'https://mixi-developers.mixi.co.jp/feed'
  },
  {
    name: 'U-NEXT Tech Blog',
    keywords: ['u-next', 'ユーネクスト'],
    url: 'https://tech.unext.co.jp/feed'
  },
  {
    name: 'Tier IV Tech Blog',
    keywords: ['tier iv', 'ティアフォー', '自動運転'],
    url: 'https://tech.tier4.jp/feed'
  },
  {
    name: 'Sansan Builders Box',
    keywords: ['sansan', 'サンサン'],
    url: 'https://buildersbox.corp-sansan.com/feed'
  },
  {
    name: 'Finatext Tech Blog',
    keywords: ['finatext', 'フィナテキスト'],
    url: 'https://techblog.finatext.com/feed'
  },
  {
    name: "Chatwork Creator's Note",
    keywords: ['chatwork', 'チャットワーク'],
    url: 'https://creators-note.chatwork.com/feed'
  },
  {
    name: 'Gunosy Tech Blog',
    keywords: ['gunosy', 'グノシー'],
    url: 'https://tech.gunosy.io/feed'
  },
  { name: 'DMM Inside', keywords: ['dmm', 'ディーエムエム'], url: 'https://inside.dmm.com/feed' },
  {
    name: 'Speee DEVELOPER BLOG',
    keywords: ['speee', 'スピー'],
    url: 'https://techrocca.speee.jp/feed'
  },
  {
    name: 'BASE Developers Blog',
    keywords: ['base', 'ベイス'],
    url: 'https://devblog.thebase.in/feed'
  },
  {
    name: 'STORES Product Blog',
    keywords: ['stores', 'ストアーズ'],
    url: 'https://product.st.inc/feed'
  },
  {
    name: 'Helpfeel Tech Blog',
    keywords: ['helpfeel', 'nota'],
    url: 'https://tech.helpfeel.com/feed'
  },
  {
    name: '10X Product Blog',
    keywords: ['10x', 'テンエックス'],
  ...
  { name: 'CADDi Tech Blog', keywords: ['caddi', 'キャディ'], url: 'https://caddi.tech/feed' },
  {
    ...
    keywords: ['layerx', 'レイヤーエックス'],
    url: 'https://tech.layerx.co.jp/feed'
  },
  {
    name: 'Visional Engineering',
    keywords: ['visional', 'ビズリーチ'],
    url: 'https://engineering.visional.inc/blog/feed'
  },
  {
    name: 'PR TIMES 開発者ブログ',
    keywords: ['pr times', 'prtimes'],
    url: 'https://developers.prtimes.jp/feed/'
  },
  {
    name: 'Goodpatch Blog',
    keywords: ['goodpatch', 'グッドパッチ'],
    url: 'https://goodpatch.com/blog/feed'
  },
  { name: 'LIG ブログ', keywords: ['lig', 'リグ', 'web制作'], url: 'https://liginc.co.jp/feed' },
  {
    name: 'クラスメソッド DevelopersIO',
    keywords: ['classmethod', 'クラスメソッド', 'aws'],
    url: 'https://dev.classmethod.jp/feed/'
  },
  {
    name: 'Serverworks Tech Blog',
    keywords: ['serverworks', 'サーバーワークス'],
    url: 'https://blog.serverworks.co.jp/feed'
  },
  {
    name: '食べログ Tech Blog',
    keywords: ['tabelog', '食べログ'],
    url: 'https://tech-blog.tabelog.com/feed'
  },
  {
    name: 'くらしのマーケット Tech Blog',
    keywords: ['minma', 'くらしのマーケット'],
    url: 'https://tech.minma.jp/feed'
  },
  {
    name: 'KAKEHASHI Tech Blog',
    keywords: ['kakehashi', 'カケハシ'],
    url: 'https://kakehashi-dev.hatenablog.com/feed'
  },
  ...
  },
  {
    ...
    keywords: ['uber', 'ウーバー'],
    url: 'https://www.uber.com/en-JP/blog/engineering/rss/'
  },
  {
  ...
  {
    name: 'GitLab Blog',
    keywords: ['gitlab', 'ギットラボ'],
    url: 'https://about.gitlab.com/atom.xml'
  },
  {
    name: 'Docker Blog',
    keywords: ['docker', 'ドッカー'],
  ...
  { name: 'CSS-Tricks', keywords: ['css-tricks', 'css'], url: 'https://css-tricks.com/feed/' },
  {
    ...
    keywords: ['smashing magazine', 'フロントエンド'],
  ...
  // ==========================================
  {
    name: 'IPA 情報セキュリティ 重要なセキュリティ情報',
    keywords: ['ipa', 'セキュリティ', 'sc'],
    url: 'https://www.ipa.go.jp/security/rss/alert.xml'
  },
  {
    name: 'JPCERT/CC 注意喚起',
    keywords: ['jpcert', 'インシデント'],
    url: 'https://www.jpcert.or.jp/rss/jpcert.rdf'
  },
  {
    name: 'Security NEXT',
    keywords: ['security next', '脆弱性'],
    url: 'https://www.security-next.com/feed'
  },
  {
    name: 'ScanNetSecurity',
    keywords: ['scannetsecurity', 'スキャンネット'],
    url: 'https://scan.netsecurity.ne.jp/rss/index.rdf'
  },
  {
    name: 'Flatt Security Blog',
    keywords: ['flatt security', 'フラットセキュリティ'],
    url: 'https://blog.flatt.tech/feed'
  },
  {
    name: 'Trend Micro Security Blog',
    keywords: ['trend micro', 'トレンドマイクロ'],
    url: 'https://blog.trendmicro.co.jp/feed/'
  },
  {
    name: 'Kaspersky Daily',
    keywords: ['kaspersky', 'カスペルスキー'],
    url: 'https://blog.kaspersky.co.jp/feed/'
  },
  {
    name: 'Palo Alto Networks Blog',
    keywords: ['palo alto', 'パロアルト'],
    url: 'https://www.paloaltonetworks.jp/company/in-the-news/rss'
  },
  ...
  { name: 'OpenAI Blog', keywords: ['openai', 'chatgpt'], url: 'https://openai.com/blog/rss.xml' },
  {
    ...
    keywords: ['deepmind', 'ディープマインド', '強化学習'],
    url: 'https://deepmind.google/blog/rss.xml'
  },
  {
    name: 'Preferred Networks (PFN)',
    keywords: ['pfn', '機械学習'],
    url: 'https://tech.preferred.jp/ja/feed/'
  },
  {
    name: 'Berkeley AI Research (BAIR)',
    keywords: ['bair', '強化学習', 'ai'],
    url: 'https://bair.berkeley.edu/blog/feed.xml'
  },
  {
    name: 'AtCoder Info',
    keywords: ['atcoder', 'アットコーダー', '競プロ'],
    url: 'https://atcoder.jp/posts.rss'
  },
  {
    name: 'chokudaiのブログ',
    keywords: ['chokudai', '競技プログラミング'],
    url: 'https://chokudai.hatenablog.com/feed'
  },
  {
    name: "E869120's Blog",
    keywords: ['e869120', '競プロ', 'アルゴリズム'],
    url: 'https://e869120.hatenablog.com/feed'
  },
  {
    name: 'Kenkooooのブログ',
    keywords: ['kenkoooo', 'atcoder problems'],
    url: 'https://kenkoooo.hatenablog.com/feed'
  },
  ...
  },
  {
    ...
    keywords: ['planetscale', 'mysql'],
    url: 'https://planetscale.com/feed'
  },
  {
    name: 'HashiCorp Blog',
    keywords: ['hashicorp', 'terraform'],
